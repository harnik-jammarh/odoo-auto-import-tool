...
// Google Drive, googleusercontent.com, or an arbitrary product-photo URL
// directly: none of those origins send back an Access-Control-Allow-Origin
// header for this app's domain, so the browser blocks it. (The Chrome
// extension version of this tool never had this problem — it runs in a
// privileged extension context with host_permissions covering "https://*/*",
// which isn't subject to CORS at all.) A serverless function has no such
// restriction, so the browser calls THIS route for two things, and this
// route makes the real call on the server and hands the result back:
//
