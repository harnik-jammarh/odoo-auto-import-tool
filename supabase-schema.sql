...
-- Migration note: if you ran this script before the Image Import feature
-- was added, `create table if not exists` above won't retroactively add the
-- new column to a table that already exists — this statement covers that
